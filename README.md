...
After the creation of BLE server call BLEOTA.begin with the Server pointer and security enabled and set the public key [5-security](#Security "Goto 5-security")
```
// Create the BLE Device
BLEDevice::init("ESP32");
